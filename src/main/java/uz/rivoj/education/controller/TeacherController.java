...
public class TeacherController {
    ...
    public ResponseEntity<List<ModuleDTO>> getAllModules(Principal principal){
        return ResponseEntity.status(200).body(moduleService.getAllModules(UUID.fromString(principal.getName())));
    }
