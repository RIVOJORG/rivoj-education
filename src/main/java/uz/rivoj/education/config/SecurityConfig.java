...
public class SecurityConfig {
        ...
        return http
                ...
                .authorizeHttpRequests(requestConfigurer -> {
                    requestConfigurer
                            ...
                            .requestMatchers("/api/v1/base/**").hasAnyRole("TEACHER", "ADMIN")
    ...
    configuration.setAllowedOrigins(List.of("https://rivoj-education.uz", "http://localhost:3000", "https://209.38.77.252:8080")); // Specific frontend domain
